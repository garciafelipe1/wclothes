...
const FOOTER_CATEGORIES = [
  ...
  { labelKey: "summerSale" as const, href: "/catalog?filter=sale" },
  { labelKey: "lastArrivals" as const, href: "/catalog?sort=newest" },
  { labelKey: "localAppointments" as const, href: "/turnos" },
  { labelKey: "clothing" as const, href: "/catalog?category=ropa" },
  { labelKey: "shoes" as const, href: "/catalog?category=zapatillas" },
  { labelKey: "brands" as const, href: "/catalog?filter=brands" },
  { labelKey: "returns" as const, href: "/devoluciones" },
]
      ...
      <div className="footer-inner">
        ...
        <div className="footer-top">
          <div className="footer-col footer-newsletter">
            ...
            <form onSubmit={handleNewsletterSubmit} className="footer-newsletter-form">
              ...
              />
              <button type="submit" className="footer-newsletter-btn" aria-label={t("submit")}>
          ...
          <div className="footer-col footer-categories">
            ...
            <ul className="footer-links">
              {FOOTER_CATEGORIES.map((item) => (
                <li key={item.href}>
                  <Link href={toPath(item.href)}>{t(item.labelKey)}</Link>
                </li>
              ))}
            </ul>
          </div>
        ...
        <div className="footer-mid">
          <div className="footer-payment-icons">
            ...
            <MastercardIcon />
            <AmexIcon />
            <span className="footer-payment-other">{t("other")}</span>
          </div>
